...
/**
 * @brief Returns a copy of the given linked list.
 * @param l
 * Pointer to the linked list.
 * @return ForwardList*
 * Pointer to the newly allocated linked list.
...
/**
 * @brief Destroys the linked list.
 *  Frees the memory allocated for the linked list and all its nodes (only the nodes, not the values).
 * @param l
 * Pointer to the linked list.
 *
 */
...
/**
 * @brief Destroys the linked list.
 *  Frees the memory allocated for the linked list and all its nodes (only the nodes, not the values or the list).
 * @param l
 * Pointer to the linked list.
 *
 */
