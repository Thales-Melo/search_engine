...
int main (int argc, char **argv) {
    ...
    Tree *index = tree_construct(compara_strings, free, collection_destroy, print_string, collection_print, fprint_string, collection_file_print);
...
// valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./index ../datasets/small